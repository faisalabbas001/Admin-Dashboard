...
export default function Home() {
  ...
  const darkColor="bg-[#242B4D] text-gray-50";
  const lightColor="bg-[#FFFFFF] text-gray-900";
  const [darkmode,setdarkmode]= useState(darkColor);
  ...
  return (
    ...
    />
     ...
     <div style={{minWidth:"30%"}}>
      <div className={`flex min-h-full flex-1 flex-col justify-center px-6 py-12 lg:px-8  shadow-lg ${darkmode}`}>
        ...
        <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
          <form action="#" method="POST" className="space-y-6">
            ...
            <div>
              <button
                type="submit"
                className="flex w-full justify-center rounded-md bg-indigo-600 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600" onClick={()=>{router.push("/dashboard")}}
              >
                Sign in
              </button>
            </div>
...
3.07705 1.72314 6.83545L5.56519 9.815C6.46951 7.09682 9.00474 5.07386 12 5.07386Z"
          ...
          <p className="mt-10 text-center text-sm text-gray-500">
            Not a member?{' '}
            <span className="font-semibold leading-6 text-indigo-600 hover:text-indigo-500 cursor-pointer" onClick={()=>{router.push("/signup")}}>
